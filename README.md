...
clashing ideologies and desperate survival. Explore its factions, key figures, and  
morally charged quests below.
...
tapestries. Their works double as maps, records, and subtle spellcraft.  
...
## Setting Integration
- **Portal Cataclysm**: Quest artifacts hint the collapse resulted from sabotage or  
  a fog "rebellion."
- **Racial Diversity**: Subverts tropes (orc artisans, gnome prophets).
- **Faction Dynamics**: Clash between preservation (Loomkeepers), recklessness (Driftkin),  
  and fanaticism (Pulsefinders).
